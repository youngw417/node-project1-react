    ...
    return (
        <div className='card'>
                ...
                <div className="card-action">
                    <a href="#EditModal" className="modal-trigger btn btn-small blue waves-effect" onClick={handleCurrent}>Edit</a>
                    <a href="#" onClick={handleClick}><i className="material-icons right">delete</i></a>
                </div>
